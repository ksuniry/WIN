...
function gfn_getTranUrl(sParam){
	...
	if(sParam.target == "home"){
		if     (sParam.appMode == "oper"){url = 'https://www.wealthguide.co.kr';}
		else if(sParam.appMode == "test"){url = 'https://www.wealthguide.co.kr';}
		else if(sParam.appMode == "dev"){url = 'https://www-dev.wealthguide.co.kr';}
		else if(sParam.appMode == "local"){url = 'https://www-dev.wealthguide.co.kr';}
		//else if(sParam.appMode == "local"){url = 'https://localhost:8002';}
		else 						 	{url = location.host;}
	}
	else if(sParam.target == "api") {
		if     (sParam.appMode == "oper"){url = 'https://api.wealthguide.co.kr';}
		else if(sParam.appMode == "test"){url = 'https://api-test.wealthguide.co.kr:6443';}
		else if(sParam.appMode == "dev"){url = 'https://api-dev.wealthguide.co.kr:6443';}
		else if(sParam.appMode == "local"){
			
			//if( (location.pathname.indexOf('UNTOPEN') > -1 || location.pathname.indexOf('ADVCEXC') > -1 || location.pathname.indexOf('PENSEXE') > -1) && gfn_getWhoToken() != 'b'){
			/*if( (location.pathname.indexOf('UNTOPEN') > -1 || location.pathname.indexOf('ADVCEXC') > -1 ) && gfn_getWhoToken() != 'b'){
				url = 'http://192.168.0.12:8000';
				return url;
			}*/
			
			if(gfn_getWhoToken() == 'h'){
				//url = 'http://211.219.167.122:8000';
				//url = 'http://'+location.hostname+':8000';
				//url = 'https://api-dev.wealthguide.co.kr:6443';
				//return url;
			}
			else if(gfn_getWhoToken() == 'b'){
				//url = 'http://192.168.0.12:8000';
				//url = 'http://'+location.hostname+':8000';
				//url = 'https://api-dev.wealthguide.co.kr:6443';
			...
			//url = 'http://'+location.hostname+':8000';
			//url = 'https://api-dev.wealthguide.co.kr:6443';
			url = 'https://apim-dev.wealthguide.co.kr';
		}
		else if(sParam.appMode == "local"){url = 'http://'+localip+':8000';}
		//else if(sParam.appMode == "local"){url = 'http://'+location.hostname+':8000';}
		//else if(sParam.appMode == "local"){url = 'https://api-dev.wealthguide.co.kr:6443';}
		else 						 	{url = location.host;}
	}
	else if(sParam.target == "auth") {
		if     (sParam.appMode == "oper"){url = 'https://auth.wealthguide.co.kr';}
		else if(sParam.appMode == "test"){url = 'https://auth-test.wealthguide.co.kr:7443';}
		else if(sParam.appMode == "dev"){url = 'https://auth-dev.wealthguide.co.kr:7443';}
		//else if(sParam.appMode == "local"){url = 'https://auth-dev.wealthguide.co.kr:7443';}
		else if(sParam.appMode == "local"){url = 'https://apim-dev.wealthguide.co.kr';}
		//else if(sParam.appMode == "local"){url = 'http://'+location.hostname+':9001';}
		else 						 	{url = location.host;}
	}
	else if(sParam.target == "appweb") {
		if     (sParam.appMode == "oper"){url = 'https://appweb.wealthguide.co.kr';}
		else if(sParam.appMode == "test"){url = 'https://appweb-test.wealthguide.co.kr';}
		else if(sParam.appMode == "dev"){url = 'https://appweb-dev.wealthguide.co.kr';}
		//else if(sParam.appMode == "local"){url = 'https://appweb-dev.wealthguide.co.kr';}
		else if(sParam.appMode == "local"){url = 'http://'+location.hostname+':' + localPort;}
		else 						 	{url = 'http://'+location.hostname+':' + localPort;}
	}
	else if(sParam.target == "oapi") {
		//url = 'http://'+location.hostname+':8888';
		url = 'http://'+location.hostname+':8101';
	}
	else{
...
function gfn_isLocal(){
	return ("localhost" == location.hostname || $('#lip').val() == location.hostname || "211.219.167.178" == location.hostname || location.hostname.indexOf('192.168') > -1 ) ? true : false;
	//return false;
}

function gfn_isDev(){
	return ("appweb-dev.wealthguide.co.kr" == location.hostname) ? true : false;
}

function gfn_isTest(){
	return ("appweb-test.wealthguide.co.kr" == location.hostname) ? true : false;
}
